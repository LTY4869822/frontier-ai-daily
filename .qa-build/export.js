...
exports.buildWeeklyMarkdown = void 0;
 ...
 */
function buildWeeklyMarkdown(summary, commentary) {
    const parts = [];
    parts.push("# 前沿 · AI 日报 · 本周热点总结");
    parts.push("");
    parts.push(`> 周期：${summary.weekStart} ~ ${summary.weekEnd} · 共 ${summary.totalHotspots} 条热点`);
    parts.push("");
    parts.push("## 本周趋势判断");
    ...
    if (commentary) {
        ...
        if (commentary.headline)
            parts.push(`- 标题：${commentary.headline}`);
...
exports.buildWeeklyMarkdown = buildWeeklyMarkdown;
